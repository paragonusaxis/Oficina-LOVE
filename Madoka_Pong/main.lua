--[[
    ...
    Made by Rocco Cavenaghi (Paragonusaxis)
]]
...
function love.load()
    ...
    -- New fonts
    gothic_font = love.graphics.newFont('fonts/gothic-font.ttf', 54)
    rune_font = love.graphics.newFont('fonts/rune-font.ttf', 64)
    serif_font = love.graphics.newFont('fonts/serif-font.otf', 24)
    small_serif_font = love.graphics.newFont('fonts/serif-font.otf', 18)
    ...
    -- Sprites
    sprites = {
        madoka = love.graphics.newImage('graphics/paddle-madoka.png'),
        homura = love.graphics.newImage('graphics/paddle-homura.png'),
        ball = love.graphics.newImage('graphics/ball.png'),
        gem_madoka = love.graphics.newImage('graphics/gem-madoka.png'),
        gem_homura = love.graphics.newImage('graphics/gem-homura.png')
    }

    -- Sounds
    sounds =  {
        wall_hit = love.audio.newSource('sounds/wall-hit.wav', 'static'),
        player_hit = love.audio.newSource('sounds/player-hit.wav', 'static'),
...
function love.draw()
    ...
    if game_state == 'start' then
        ...
        love.graphics.printf('Pong', 0, WINDOW_HEIGHT/2 - 40, WINDOW_WIDTH, 'center')
        ...
        love.graphics.draw(sprites.gem_homura, WINDOW_WIDTH - 44, 30)
